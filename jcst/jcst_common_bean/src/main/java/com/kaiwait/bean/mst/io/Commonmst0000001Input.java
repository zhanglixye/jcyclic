...
/** 
* @ClassName: Commonmst0000001Input 
* @Description: Commonmst输出实体类 
* @author mayouyi
* @date 2017年11月14日 下午2:49:27 
*  
*/
public class Commonmst0000001Input extends BaseInputBean{

	private static final long serialVersionUID = 7639921280182966909L;
	private Commonmst commonmst;//实体类
	...
	public Commonmst getCommonmst() {
		return commonmst;
	}
	public void setCommonmst(Commonmst commonmst) {
