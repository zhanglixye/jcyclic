...
public interface PaytrnService {
	...
	// 支付申请
	int PaytrnApply (PaytrnInput inputParam);
	// 付款信息批准
	int PaytrnApproval (PaytrnInput inputParam);
	// 付款信息驳回
	int PaytrnApprovalBack (PaytrnInput inputParam);
	// 付款信息取消
	int PaytrnApprovalCancel (PaytrnInput inputParam);
	//新增
