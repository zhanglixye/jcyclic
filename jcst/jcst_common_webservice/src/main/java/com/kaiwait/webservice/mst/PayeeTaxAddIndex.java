...
@Component("PayeeTaxAdd")
public class PayeeTaxAddIndex  implements SingleFunctionIF<PayeeTaxAddInput> {
	...
	public  Object process(PayeeTaxAddInput inputParam) {
		...
		return PayeeTaxService.insertPayeetaxmstTx(inputParam.getPayeetaxmst());
	}
