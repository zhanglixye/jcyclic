...
@Component("MsgtrnDelete")

public class MsgtrnDelete implements SingleFunctionIF<MsgtrnInput>{
...
//		//管理组权限+管理公司级别+一定有留言板权限 可以增删改系统消息，不能增删改个人留言
...
//		//管理组权限没有一般公司
//		
//		//无管理组权限+一般公司级别+留言板权限  可以增删改个人消息，不能增删改系统消息
...
//		}
		//留言板权限
				...
				return MsgtrnService.DeleteMsgtrnTx(inputParam);
	}
