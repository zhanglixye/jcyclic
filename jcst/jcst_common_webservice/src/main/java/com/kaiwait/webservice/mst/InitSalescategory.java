...
*  
*/
@Component("initSalescategory")
public class InitSalescategory implements SingleFunctionIF<SalemstInput>{

	@Resource
	private SalemstService SalemstService;
	
	@Override
	public SalemstVo process(SalemstInput inputParam) {
	return SalemstService.initSalescategory(inputParam);	
	}
