...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.2)", date = "2017-12-12")
public class DynamicJsonService {

  public interface Iface {

    public String invoke(String jsonMsg) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void invoke(String jsonMsg, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_invoke(String jsonMsg) throws org.apache.thrift.TException
    {
      invoke_args args = new invoke_args();
      args.setJsonMsg(jsonMsg);
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void invoke(String jsonMsg, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      invoke_call method_call = new invoke_call(jsonMsg, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class invoke_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public invoke_call(String jsonMsg, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class invoke<I extends Iface> extends org.apache.thrift.ProcessFunction<I, invoke_args> {
      ...
      public invoke_result getResult(I iface, invoke_args args) throws org.apache.thrift.TException {
        invoke_result result = new invoke_result();
        result.success = iface.invoke(args.jsonMsg);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class invoke<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, invoke_args, String> {
      ...
      public void start(I iface, invoke_args args, org.apache.thrift.async.AsyncMethodCallback<String> resultHandler) throws TException {
        iface.invoke(args.jsonMsg,resultHandler);
      }
    }
  ...
  public static class invoke_args implements org.apache.thrift.TBase<invoke_args, invoke_args._Fields>, java.io.Serializable, Cloneable, Comparable<invoke_args>   {
    ...
    private static final org.apache.thrift.protocol.TField JSON_MSG_FIELD_DESC = new org.apache.thrift.protocol.TField("jsonMsg", org.apache.thrift.protocol.TType.STRING, (short)1);
    ...
    public String jsonMsg; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      JSON_MSG((short)1, "jsonMsg");
    ...
    static {
      ...
      tmpMap.put(_Fields.JSON_MSG, new org.apache.thrift.meta_data.FieldMetaData("jsonMsg", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    public invoke_args setJsonMsg(String jsonMsg) {
      this.jsonMsg = jsonMsg;
      return this;
    }

    public void unsetJsonMsg() {
      this.jsonMsg = null;
    }

    /** Returns true if field jsonMsg is set (has been assigned a value) and false otherwise */
    public boolean isSetJsonMsg() {
      return this.jsonMsg != null;
    }

    public void setJsonMsgIsSet(boolean value) {
      if (!value) {
        this.jsonMsg = null;
      }
    }
    ...
    public boolean equals(invoke_args that) {
      ...
      boolean this_present_jsonMsg = true && this.isSetJsonMsg();
      boolean that_present_jsonMsg = true && that.isSetJsonMsg();
      if (this_present_jsonMsg || that_present_jsonMsg) {
        if (!(this_present_jsonMsg && that_present_jsonMsg))
          return false;
        if (!this.jsonMsg.equals(that.jsonMsg))
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_jsonMsg = true && (isSetJsonMsg());
      list.add(present_jsonMsg);
      if (present_jsonMsg)
        list.add(jsonMsg);
    ...
    public int compareTo(invoke_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetJsonMsg()).compareTo(other.isSetJsonMsg());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetJsonMsg()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.jsonMsg, other.jsonMsg);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    private static class invoke_argsStandardScheme extends StandardScheme<invoke_args> {
          ...
          switch (schemeField.id) {
            case 1: // JSON_MSG
              if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                struct.jsonMsg = iprot.readString();
                struct.setJsonMsgIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, invoke_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.jsonMsg != null) {
          oprot.writeFieldBegin(JSON_MSG_FIELD_DESC);
          oprot.writeString(struct.jsonMsg);
          oprot.writeFieldEnd();
        }
