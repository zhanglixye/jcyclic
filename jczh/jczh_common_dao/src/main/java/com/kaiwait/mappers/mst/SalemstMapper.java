...
public interface SalemstMapper extends BaseMapper{
	...
	*/
	...
	List<SalemstVo> selectRateByCD(@Param("sale_cd") String sale_cd,@Param("companyID") String companyID,@Param("pd") String pd);
	
	List<SalemstVo> selectRateByCDlt(@Param("sale_cd") String sale_cd,@Param("companyID") String companyID,@Param("pd") String pd);
	
	List<SalemstVo> selectRateByCDgt(@Param("sale_cd") String sale_cd,@Param("companyID") String companyID,@Param("pd") String pd);
	...
	*/
	...
	Salemst selectNewVatRatedy(@Param("sale_cd") String sale_cd,@Param("companyID") String companyID,@Param("pd") String pd);


	Salemst selectSaleratedy(@Param("sale_cd") String sale_cd,@Param("companyID") String companyID,@Param("pd") String pd);


	Salemst selectSalerates(@Param("sale_cd") String sale_cd,@Param("companyID") String companyID,@Param("pd") String pd);


	List<SalemstVo> select(@Param("sale_cd") String sale_cd,@Param("sale_account_cd") String sale_account_cd,@Param("sale_name") String sale_name,@Param("del_flg") String del_flg,@Param("companyID") String companyID,@Param("pd") String pd);


	Salemst selectNewVatRates(@Param("sale_cd") String sale_cd,@Param("companyID") String companyID, @Param("pd") String pd);


	List<SalemstVo> selectVatRateByCD(@Param("sale_cd") String sale_cd,@Param("companyID") String companyID, @Param("pd") String pd);


	List<SalemstVo> selectVatRateByCDlt(@Param("sale_cd") String sale_cd,@Param("companyID") String companyID, @Param("pd") String pd);


	List<SalemstVo> selectVatRateByCDgt(@Param("sale_cd") String sale_cd,@Param("companyID") String companyID, @Param("pd") String pd);
