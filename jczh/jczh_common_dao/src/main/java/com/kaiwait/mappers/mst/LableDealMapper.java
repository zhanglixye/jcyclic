...
public interface LableDealMapper {
	  int bindLable(@Param("jobcd")String jobcd,@Param("inputno")String inputno,@Param("lablelevel")int lablelevel,@Param("lableid")String lableid,@Param("companycd")int companycd,
	   ...
	   //是否有这个标签了
	   int isHaveLable(@Param("labletype")int labletype,@Param("labletext")String labletext,@Param("lablelevel")int lablelevel,@Param("usercd")String usercd,@Param("companycd")int companycd);
	   //追加标签
	   int addLable(Lable lable);
	   String selectInputNo(@Param("inputno")String inputno,@Param("companycd") String companyID,@Param("newinputno") String newinputno);
	   String getTranInputNo(@Param("jobcd")String jobcd,@Param("inputno")String inputno,@Param("companyID")String companyID);
       String getLendInputNo(@Param("jobcd")String jobcd,@Param("inputno")String inputno,@Param("companyID")String companyID);
