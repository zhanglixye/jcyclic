 ...
 * 
 */
@Component("commonmstAdd")
public class commonmstAdd implements SingleFunctionIF<Commonmst0000001Input> {
	...
	public Object process(Commonmst0000001Input inputParam) {
		...
		List<CommonmstVo> com = CommonmstService.selectComByCd(inputParam.getMstcd(), inputParam.getItemcd(), Integer.parseInt(inputParam.getCompanyID()));
	    if (com.size()!=0) {
	    	return messge;
	    }
		  
		  return CommonmstService.insertNewTx(monmst); 
	}
