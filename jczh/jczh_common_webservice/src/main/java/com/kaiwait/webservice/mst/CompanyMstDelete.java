...
@Component("companyMstDel")
public class CompanyMstDelete implements SingleFunctionIF<CompanyMstInput>{
    @Resource
    private CompanyService companyService; 
	@Override
	public Integer process(CompanyMstInput inputParam) {
		// TODO Auto-generated method stub
        	return companyService.deleteFlgTx(inputParam.getCompany());
	}
	@Override
