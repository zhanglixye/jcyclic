...
*/
@Component("RateSel")
public class RateSel implements SingleFunctionIF<SalemstInput>{
	...
	public List<SalemstVo> process(SalemstInput inputParam) {
		if(inputParam.getSale_cd()!=null) {
			...
			//return SalemstService.selectRateByCD(inputParam.getSale_cd(),inputParam.getCompanyID(),inputParam.getPd());	
			return SalemstService.selectRateByCD(inputParam.getSale_cd(),inputParam.getCompanyID());	
		}
		return null;
