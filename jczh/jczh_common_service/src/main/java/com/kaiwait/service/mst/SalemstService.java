...
public interface SalemstService {
	...
	*/	
	...
	List<SalemstVo> selectVatRateByCD(String sale_cd,String companyID,String pd);
	...
	*/	
	...
	List<SalemstVo> selectRateByCD(String sale_cd,String companyID,String pd);
	/** 
	* @Title: selectVatRateByCD 
	...
	*/	
	...
	Object salemstUpdInit(String sale_cd, String companyID, String pd);
