...
public class LableDealServiceImp implements LableDealService{
	...
	public Object listLableAddTx(LableInput inputParam) {
		// TODO Auto-generated method stub
			...
			int num = lableDealMapper.isHaveLable(Integer.valueOf(lable.getLabletype()),lable.getLabletext(), lable.getLablelevel(),inputParam.getUserID(), Integer.valueOf(inputParam.getCompanyID()));
			if(num>0) {
				return 250;
			}
