...
public class JobList {
	...
	private String jobuserupdate="";
	private String jobuserdeflg="";
	private String jobuseradddate="";
	private String profit="";
	private String profitRate="";
	private String jobInvNo;
	private String jobInvoiceFlg;
	...
	public String getJobInvoiceFlg() {
		return jobInvoiceFlg;
	}
	public void setJobInvoiceFlg(String jobInvoiceFlg) {
		this.jobInvoiceFlg = jobInvoiceFlg;
	}
	public String getJobInvNo() {
		return jobInvNo;
	}
	public void setJobInvNo(String jobInvNo) {
		this.jobInvNo = jobInvNo;
	}
	...
	public String getJobuseradddate() {
		return jobuseradddate;
	}
	public void setJobuseradddate(String jobuseradddate) {
		this.jobuseradddate = jobuseradddate;
	}
	public String getJobuserdeflg() {
		return jobuserdeflg;
	}
	public void setJobuserdeflg(String jobuserdeflg) {
		this.jobuserdeflg = jobuserdeflg;
	}
	public String getJobuserupdate() {
		return jobuserupdate;
	}
	public void setJobuserupdate(String jobuserupdate) {
		this.jobuserupdate = jobuserupdate;
	}
