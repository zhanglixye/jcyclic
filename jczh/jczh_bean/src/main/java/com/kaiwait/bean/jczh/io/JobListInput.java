...
public class JobListInput extends BaseInputBean{
	...
	private String jInvNo;
	private String sellInvoiceFlg;
	...
	public String getSellInvoiceFlg() {
		return sellInvoiceFlg;
	}
	public void setSellInvoiceFlg(String sellInvoiceFlg) {
		this.sellInvoiceFlg = sellInvoiceFlg;
	}
	public String getjInvNo() {
		return jInvNo;
	}
	public void setjInvNo(String jInvNo) {
		this.jInvNo = jInvNo;
	}
