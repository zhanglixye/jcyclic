...
public class Costtrn{
	...
	private String  plan_dlvday;
	private String  cost_remark;
	private String  cost_rate;
	private String  cost_foreign_amt;
	private String  cost_rmb;
	private String  cost_vat_amt;
	private String  cost_pay_amt;
	private String  cost_cure_code;
	private String  cost_use_date;
	private String  cost_ishave;
	private String  cost_refer;
	private String  cost_foreign_type;
    ...
    //项 新增 存储税率
    private String cost_vat_rate;
		

		public String getCost_vat_rate() {
		return cost_vat_rate;
	}

	public void setCost_vat_rate(String cost_vat_rate) {
		this.cost_vat_rate = cost_vat_rate;
	}
	...
	public String getOutput_flg() {
		return output_flg;
	}
	public void setOutput_flg(String output_flg) {
		this.output_flg = output_flg;
	}
