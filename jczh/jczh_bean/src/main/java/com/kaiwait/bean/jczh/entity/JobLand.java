...
public String getJobIsEditMDFlg() {
	return jobIsEditMDFlg;
}
public void setJobIsEditMDFlg(String jobIsEditMDFlg) {
	this.jobIsEditMDFlg = jobIsEditMDFlg;
}
...
public String getSale_vat_rate() {
	return sale_vat_rate;
}
public void setSale_vat_rate(String sale_vat_rate) {
