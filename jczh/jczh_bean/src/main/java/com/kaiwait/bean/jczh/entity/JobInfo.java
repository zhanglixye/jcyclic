...
public class JobInfo {
	...
	private String plansaleamt;
	private int jobFromJpp;
	...
	public int getJobFromJpp() {
		return jobFromJpp;
	}

	public void setJobFromJpp(int jobFromJpp) {
		this.jobFromJpp = jobFromJpp;
	}
	public String getPlansaleamt() {
		return plansaleamt;
	}

	public void setPlansaleamt(String plansaleamt) {
