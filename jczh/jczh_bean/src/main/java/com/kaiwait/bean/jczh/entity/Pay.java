...
public class Pay{
	...
	public int getPayFromJpp() {
		return payFromJpp;
	}
	public void setPayFromJpp(int payFromJpp) {
		this.payFromJpp = payFromJpp;
	}
	...
	public String getIspayskip() {
		return ispayskip;
	}
	public void setIspayskip(String ispayskip) {
		this.ispayskip = ispayskip;
	}
