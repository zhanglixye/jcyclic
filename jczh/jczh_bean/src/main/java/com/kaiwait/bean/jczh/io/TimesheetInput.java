...
public class TimesheetInput extends BaseInputBean {
	...
	public void setAllmap(HashMap<String, Object> allmap) {
		this.allmap = allmap;
	}

	private String outputsheetqx;//打印タイムシート集計表权限


	public String getOutputsheetqx() {
		return outputsheetqx;
	}
	public void setOutputsheetqx(String outputsheetqx) {
		this.outputsheetqx = outputsheetqx;
	}
