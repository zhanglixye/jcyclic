...
@Component("PaytrnApprovalCancel")

public class PaytrnApprovalCancel implements SingleFunctionIF<PaytrnInput>{
	...
	public Object process(PaytrnInput inputParam) {
		...
		int ss =PaytrnService.PaytrnApprovalCancelTx(inputParam);
		return ss;
