...
@Component("PaytrnApproval")

public class PaytrnApproval implements SingleFunctionIF<PaytrnInput>{
	...
	public Object process(PaytrnInput inputParam) {
		...
		inputParam.getPaytrn().setConfirmemp(userid);
		return  PaytrnService.PaytrnApprovalTx(inputParam);
