...
@Component("LendtrnAdd")

public class LendtrnAdd implements SingleFunctionIF<LendtrnInput>{
	...
	public Object process(LendtrnInput inputParam) {
		...
		inputParam.getLendtrn().setInput_no(id);
		inputParam.getLendtrn().setCompany_cd(companycd);
		return LendtrnService.LendtrnAddTx(inputParam);
