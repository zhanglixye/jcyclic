...
public interface CommonMethedService {
    ...
    String profitRateFormat(String num);
    List<AccountEntries> calcuateAccountEntriesJobTax(List<AccountEntries> accountList,String thisMonth,String beforMonth);
    String getCompanyName(String companyID);
    Calculate calcuateJobTaxByJobExcel(String jobNo,int companyID);
}
