...
public interface MonthBalanceMapper extends BaseMapper{
	AccountMonth getAccountInfo(@Param("companyID")int companyID,@Param("sysDate")String sysDate,@Param("dalDay")String dalDay);
	...
	int updateJobSetEndDate(@Param("companyID")int companyID,@Param("jobList")List<Job> jobList,@Param("accountDate")Date accountDate);
...
//	int updateTranEnd(@Param("companyID")int companyID,@Param("jobList")List<Job> jobList);
	int updateCostEnd(@Param("companyID")int companyID,@Param("aMonth")Date aMonth);
	int updateLendEnd(@Param("companyID")int companyID,@Param("aMonth")Date aMonth);
	int updateTranEnd(@Param("companyID")int companyID,@Param("aMonth")Date aMonth);
	...
	List<Job> getSellsRate(@Param("companyID")int companyID,@Param("sysDate")String sysDate);
	List<Job> selectDifferentTaxRates(@Param("companyID")int companyID,@Param("sysDate")String sysDate);
	int getselectskip(@Param("companyID")int companyID);
}