...
public interface JobLandMapper extends BaseMapper{
   ...
   //删除job
   int delJob(@Param("jobcd")String jobcd,@Param("companycd")int companycd,@Param("dbname")String dbname,@Param("usercd")String usercd,@Param("delFlg")int delFlg,@Param("level")String level,@Param("lockFlg")int lockFlg,@Param("updDate") String updDate);
   ...
   List<JobList> selectjobhistrn(@Param("jobcd")String jobcd,@Param("company_cd")int company_cd);
   String getNameByUserName(@Param("jobcd")String jobcd,@Param("companycd") int companycd);
   String selectOldInputNo(@Param("companycd")String companyID, @Param("newinputno")String newinputno);
}
