...
public interface CostMapper extends BaseMapper{
	...
	*/
	...
	List<Cost> selectpayTax(CostInput cost1);

	String SelectLogName(@Param("companyID")String companyID, @Param("cost_no")String costno, @Param("job_cd")String jobcd);

	String selectCheckDate(@Param("job_cd")String job_cd, @Param("companyID")String companyID,@Param("cost_no")String Cost_no);

	CostPDF OrderPDF(@Param("companyID")String companyID, @Param("jobNo")String jobNo, @Param("costNo")String costNo);

	String selectOrderCLDIV(@Param("inputNo")String input_no,@Param("companyID") String companycd);
