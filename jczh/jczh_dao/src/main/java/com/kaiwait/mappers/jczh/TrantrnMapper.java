...
//	
	...
	*/
	...
	TrantrnApprovalBeen TrantrnApprovalPDF(@Param("jobcd")String jobcd,@Param("companycd")int companycd,@Param("inputno")String inputno,@Param("langTyp")String langTyp);
	...
	String getInputNo(@Param("jobcd")String jobcd,@Param("inputno")String inputno,@Param("companyID")String companyID);
}