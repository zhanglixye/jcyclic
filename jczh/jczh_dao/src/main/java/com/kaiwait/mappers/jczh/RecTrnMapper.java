...
public interface RecTrnMapper extends BaseMapper{
	...
	*/
	...
	//若没有选清除入金日期则不更新 rec_date字段 
	int RecTrnUpdateMoreTxNodate(RecTrnInput inputParam);
	/**
	* 方法名 RecTrnInsertTx
	* 方法的说明  插入入金表数据
	* @param List<RecTrnInput>
	...
	*/
	...
	RecTrn getRecAll(@Param("jobcd") String jobcd,@Param("companycd")int companycd,@Param("reccd")String reccd);
