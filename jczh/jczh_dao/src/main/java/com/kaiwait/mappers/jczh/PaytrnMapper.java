...
//	
	...
	*/
	...
	List<Costtrn> selectCostRate(Paytrn paytrn);
	Paytrn selectpayvatrate(@Param("inputno")String input_no, @Param("companycd")String companycd);
	List<Paytrn> Paytrntype(Paytrn paytrn);
	List<Paytrn> Paytrntype(@Param("inputno")String input_no,@Param("companycd")String company_cd);
}