...
$(function() {
	...
	clearCard("jobCreat-select-1","jobCreat-usercd-1","jobCreat-username-1","jobCreat-userlevel-1","jobCreat-usercode-1");
});
//是否应该有MD选项
...
//			}
			ele.before('<div class="col-md-4 panel person" style="padding:5px;margin-bottom:0;width:225px;background:#fff"><div class="person-t"><div class="person-t-l"><select name="boostrap-select " class="form-control" id="'+selectID+'"><option class="i18n" name="jobregistration_business_ren" value="2" >'+part_language_change_new('jobregistration_business_ren')+'</option><option class="i18n" name="jobregistration_bear_ren" value="3" >'+part_language_change_new('jobregistration_bear_ren')+'</option></select></div><div class="person-t-r"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button></div></div><div class="person-m"><div class="person-m-l"><i class="iconfont icon-ren" id="'+colorid+'"></i></div><div class="person-m-m"><div name="userlevel" id="' + levelid + '"></div><div class="usercode hidden" id="' + usercode + '"></div><div class="usercd" id="' + userid + '"></div><div class="username" id="' + username + '"></div></div><div class="person-m-r"><i class="iconfont icon-sousuo" id="' + iid + '" ></i></div></div><div class="person-b"><label><input type="checkbox" class="level_flg" id="inlineCheckbox44" value="option4"> <span class="iconfont icon-duihaok"></span><span class="i18n" name="jobregistration_person_in_charge">'+part_language_change_new('jobregistration_person_in_charge')+'</span></label></div></div>');
