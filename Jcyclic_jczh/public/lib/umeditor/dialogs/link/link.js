(function(){
    ...
    UM.registerWidget('link', {
        tpl: "<style type=\"text/css\">" +
            ".edui-dialog-link .edui-link-table{font-size: 12px;margin: 10px;line-height: 30px;margin:0 auto}" +
            ".edui-dialog-link .edui-link-txt{width:300px;height:30px;line-height:21px;border:1px solid #d7d7d7;}" +
            "</style>" +
            ...
            "<tr>" +
            "<td></td>" +
            "<td><input class=\"edui-link-txt form-control\" id=\"edui-link-Jhref\" type=\"text\" /></td>" +
            "</tr>" +
            "<tr>" +
            "<td></td>" +
            ...
            "<tr>" +
            "<td></td>" +
            "<td><input class=\"edui-link-txt form-control\" id=\"edui-link-Jtitle\" type=\"text\"/></td>" +
            "</tr>" +
            "<tr>" +
