...
},plugins:["draggable","droppable","resizable","pagination","tooltipNew","linkbutton","menu","menubutton","splitbutton","switchbutton","progressbar","tree","textbox","passwordbox","filebox","combo","combobox","combotree","combogrid","combotreegrid","tagbox","numberbox","validatebox","searchbox","spinner","numberspinner","timespinner","datetimespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","datalist","tabs","accordion","window","dialog","form"],parse:function(_c){
var aa=[];
...
(function($){
function init(_1ef){
$(_1ef).addClass("tooltipNew-f");
};
function _1f0(_1f1){
var opts=$.data(_1f1,"tooltipNew").options;
$(_1f1).unbind(".tooltipNew").bind(opts.showEvent+".tooltipNew",function(e){
$(_1f1).tooltipNew("show",e);
}).bind(opts.hideEvent+".tooltipNew",function(e){
$(_1f1).tooltipNew("hide",e);
}).bind("mousemove.tooltipNew",function(e){
if(opts.trackMouse){
opts.trackMouseX=e.pageX;
opts.trackMouseY=e.pageY;
$(_1f1).tooltipNew("reposition");
}
});
};
function _1f2(_1f3){
var _1f4=$.data(_1f3,"tooltipNew");
if(_1f4.showTimer){
...
$(_1f6).tooltipNew("arrow").css("left",tip._outerWidth()/2+pos.left);
pos.left=0;
}
}else{
...
$(_1f6).tooltipNew("arrow").css("left",tip._outerWidth()/2-(pos.left-left));
}
}
}
}
...
tip.removeClass("tooltipNew-top tooltipNew-bottom tooltipNew-left tooltipNew-right").addClass("tooltipNew-"+opts.position);
var left,top;
...
var _1fe=$.data(_1fd,"tooltipNew");
var opts=_1fe.options;
var tip=_1fe.tip;
if(!tip){
tip=$("<div tabindex=\"-1\" class=\"tooltipNew\">"+"<div class=\"tooltipNew-content\"></div>"+"<div class=\"tooltipNew-arrow-outer\"></div>"+"<div class=\"tooltipNew-arrow\"></div>"+"</div>").appendTo("body");
_1fe.tip=tip;
_1ff(_1fd);
}
_1f2(_1fd);
_1fe.showTimer=setTimeout(function(){
$(_1fd).tooltipNew("reposition");
tip.show();
opts.onShow.call(_1fd,e);
var _200=tip.children(".tooltipNew-arrow-outer");
var _201=tip.children(".tooltipNew-arrow");
...
_207.tip.children(".tooltipNew-content").html(cc);
opts.onUpdate.call(_205,cc);
};
function _208(_209){
var _20a=$.data(_209,"tooltipNew");
if(_20a){
_1f2(_209);
...
$.removeData(_209,"tooltipNew");
$(_209).unbind(".tooltipNew").removeClass("tooltipNew-f");
opts.onDestroy.call(_209);
}
};
$.fn.tooltipNew=function(_20b,_20c){
if(typeof _20b=="string"){
return $.fn.tooltipNew.methods[_20b](this,_20c);
}
_20b=_20b||{};
return this.each(function(){
var _20d=$.data(this,"tooltipNew");
if(_20d){
$.extend(_20d.options,_20b);
}else{
$.data(this,"tooltipNew",{options:$.extend({},$.fn.tooltipNew.defaults,$.fn.tooltipNew.parseOptions(this),_20b)});
init(this);
}
_1f0(this);
_1ff(this);
...
$.fn.tooltipNew.methods={options:function(jq){
return $.data(jq[0],"tooltipNew").options;
},tip:function(jq){
return $.data(jq[0],"tooltipNew").tip;
},arrow:function(jq){
return jq.tooltipNew("tip").children(".tooltipNew-arrow-outer,.tooltipNew-arrow");
},show:function(jq,e){
return jq.each(function(){
_1fc(this,e);
});
...
$.fn.tooltipNew.parseOptions=function(_20f){
var t=$(_20f);
...
$.fn.tooltipNew.defaults={position:"bottom",content:null,trackMouse:false,deltaX:0,deltaY:0,showEvent:"mouseenter",hideEvent:"mouseleave",showDelay:200,hideDelay:100,onShow:function(e){
},onHide:function(e){
...
_223.find(".tooltipNew-f").each(function(){
$(this).tooltipNew("reposition");
});
...
t.find(".tooltipNew-f").each(function(){
$(this).tooltipNew("destroy");
});
...
_248.find(".tooltipNew-f").each(function(){
$(this).tooltipNew("hide");
});
_248.stop(true,true);
_248._size("unfit");
...
t.tooltipNew($.extend({},opts.tipOptions,{content:_4cd,position:opts.tipPosition,deltaX:opts.deltaX,deltaY:opts.deltaY})).tooltipNew("show");
}
}
};
function _4d0(_4d1){
...
$(this).tooltipNew("tip").css({color:"#000",borderColor:"#CC9933",backgroundColor:"#FFFFCC"});
},onHide:function(){
$(this).tooltipNew("destroy");
...
//iframe的情况下会是undefined加条件判断
if(language == undefined){
	language = parent.$('select.selectpicker.language_conversion').val();
}
//修改了一下源码 databox 国际化
if(language == 'jp'){
	opts.weeks = ['日','月','火','水','木','金','土'];
	opts.months = ['1月', '2月', '3月', '4月', '5月', '6月', '7月', '8月', '9月', '10月', '11月', '12月'];
}else if(language == 'zc'){
	opts.weeks = ['日','一','二','三','四','五','六'];
	opts.months = ['一月','二月','三月','四月','五月','六月','七月','八月','九月','十月','十一月','十二月'];
}else if(language == 'en'){
	opts.weeks = ['S','M','T','W','T','F','S'];
	opts.months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
}else{
	opts.weeks = ['日','一','二','三','四','五','六'];
	opts.months = ['一月','二月','三月','四月','五月','六月','七月','八月','九月','十月','十一月','十二月'];
}
