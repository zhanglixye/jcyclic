...
$.extend({
	...
	getAjaxPath:function(){
		//return "http://127.0.0.1:8080/jcyclic_front/main/dynamic/";
		//return "http://192.168.0.101:8080/jcyclic_front/main/dynamic/";
		return "http://192.168.0.37:8080/jcyclic_front/main/dynamic/";
		...
		//return "https://front1.j-cyclic.cn:8443/jcyclic_front/main/dynamic/";//32
		//return "https://front2.j-cyclic.cn:8443/jcyclic_front/main/dynamic/";//47
		//return "https://front1.j-cyclic.com.cn:8443/jcyclic_front/main/dynamic/";//224
		//return "https://front2.j-cyclic.com.cn:8443/jcyclic_front/main/dynamic/";//158
	},
	getUploadFilePath:function(){
		//return "http://192.168.0.101:8080/jcyclic_front/uploadFile/jcUpCsvFile/";
		return "http://192.168.0.37:8080/jcyclic_front/uploadFile/jcUpCsvFile/";
		...
		//return "https://front1.j-cyclic.cn:8443/jcyclic_front/uploadFile/jcUpCsvFile/";//32
		//return "https://front2.j-cyclic.cn:8443/jcyclic_front/uploadFile/jcUpCsvFile/";//47
		//return "https://front1.j-cyclic.com.cn:8443/jcyclic_front/uploadFile/jcUpCsvFile/";//224
		//return "https://front2.j-cyclic.com.cn:8443/jcyclic_front/uploadFile/jcUpCsvFile/";//158
	},
	//跳转页面共通地址部分
...
function headTimeInit(dateCompanyZone)
{
	...
	var timeAddObj = {};
	timeAddObj.a = new Date(ajaxStr);//ajax的系统时间
